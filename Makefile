...
PACKAGE_NAME          := github.com/Lazychain/artela-rollkit
...
install:
	@echo "--> Installing Artella Rollkit CLI"
	@go install -o artella-rollkitd ./cmd/artrolld
	@echo "--> Artella Rollkit CLI Installed!"
	@echo "    Check the version with: artella-rollkitd version"
	@echo "    Check the binary with: which artella-rollkitd"
.PHONY: install
